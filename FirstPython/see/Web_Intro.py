...
def find_second (search_string, target):
    position_1 = search_string.find(target);
    position_2 = search_string.find(target, position_1 + 1);
    return position_2;
...
a = 10;
b = 11;
speed_of_light_in_meter = 299792458;

bits = 8.0 * (2 ** 40);
nano_dollars = 100 * (10 ** 9);
...
def find_element_1(p, target):
    result = -1;
    if (target in p):
        result = p.index(target);
    return result;
...
def get_next_target(page):
    ...
    # this is a <a href="http://udacity.com">link!</a>
...
def crawl_web (seed):
    ...
    crawled = [];
    while toCrawl:
        page = toCrawl.pop(); #get last element
...
#print (summm (a, b));
#print (summm ('de', 'fine'));
#print ('Square: '), (square (523354));
#print (find_second ('abdasdasdj', 'j'));
#print (is_friend('fiane'));
#print (biggest(12, 1, 55));
#print_num (3);
#a, b = b, a
#print (a), (b);
...
#print (spy);
#print (len(p)), (p);
#print (nano_dollars / bits);
#print (sum_list([12, 32, 3, 34]))
