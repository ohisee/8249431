...
def gruesome(input_text):
    # write your code here
    #regstr = r"(?:[ac-su-zAC-SU-Z]*[bB][ac-su-zAC-SU-Z]*[tT][a-zA-Z]*)|(?:[ac-su-zAC-SU-Z]*[tT][a-fh-zA-FH-Z]*[gG][a-zA-Z]*)";
    regstr = r"(?:[ac-su-zA-Z]*[b][ac-su-z]*[t][a-z]*)|(?:[ac-su-zA-Z]*[t][a-fh-z]*[g][a-z]*)";
    return re.findall(regstr, input_text);
