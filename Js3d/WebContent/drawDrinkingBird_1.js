...
function createSupport() {
	...
	// right foot
	// Use same cube created for left foot, only change to negative Z position
	...
	// right leg
	// Use same cube created for left leg, only change to negative Z position
...
function createBody() {
   ...
   body.position.x = 0;
   body.position.y = 160; // y is space above 0 to the spine
   body.position.z = 0;
   scene.add(body);
   ...
   // Spine: cylinder, blue, diameter 24, length 390  
   var spine;
   spine = new THREE.Mesh( new THREE.CylinderGeometry((24/2), (24/2), 390, 32), cylinderMaterial);
   spine.position.x = 0;			// start at X = 0
   spine.position.y = 160+(390/2);	// y is half of 160 (space above 0 to the body) plus height of spine
   spine.position.z = 0;			// z is 0
   scene.add(spine);
}
...
function createHead() {
   ...
   head.position.x = 0;
   head.position.y = 390+160; // y is height of spine plus and space above 0 to the spine
   head.position.z = 0;
   scene.add(head);
   ...
   // Head: sphere, red (sphereMaterial), diameter 104     
   var hatBottom;
   hatBottom = new THREE.Mesh( new THREE.CylinderGeometry((142/2), (142/2), 10, 32), cylinderMaterial);
   hatBottom.position.x = 0;
   hatBottom.position.y = 160+390+40+(10/2); // y is space above 0 to the spine plus height of spine plus half of radius of head
   hatBottom.position.z = 0;
   scene.add(hatBottom);
   
   var hatTop;
   hatTop = new THREE.Mesh( new THREE.CylinderGeometry((80/2), (80/2), 70, 32), cylinderMaterial);
   hatTop.position.x = 0;
   hatTop.position.y = 160+390+40+10+(70/2);
   hatTop.position.z = 0;
   scene.add(hatTop);
}
