...
function drawSquare(x1, y1, x2, y2) {
	...
	// Your code goes here
	square.vertices.push( new THREE.Vector3(x1, y1, 0) ); // at index 0
	square.vertices.push( new THREE.Vector3(x2, y2, 0) ); // at index 1
	square.vertices.push( new THREE.Vector3(x2, y1, 0) ); // at index 2
	//square.faces.push( new THREE.Face3(0, 1, 2) );
	
	square.vertices.push( new THREE.Vector3(x1, y1, 0) ); // at index 3
	square.vertices.push( new THREE.Vector3(x1, y2, 0) ); // at index 4
	square.vertices.push( new THREE.Vector3(x2, y2, 0) ); // at index 5
	//square.faces.push( new THREE.Face3(3, 4, 5) );
	
	square.faces.push( new THREE.Face4(0, 2, 5, 4) );
