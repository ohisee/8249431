...
public class WeatherContract {
	...
	// The content authority is a name for the entire content provider, similar to the relation 
	...
	public static final class WeatherEntry implements BaseColumns {
		...
		// Build URI using Id, location setting, start date
		...
		// Get info - helper function to decode URI
	...
	public static final class LocationEntry implements BaseColumns {
		...
		// styling,"Mountain View" is more recognizable than 94043.
