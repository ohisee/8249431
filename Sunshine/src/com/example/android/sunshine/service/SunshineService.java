...
public class SunshineService extends IntentService {
	...
	public static final String NAME = "SunshineService";
	...
	private String[] getWeatherDataFromJson(String forecastJsonStr,
		...
		if (cVector.size() > 0) {
			...
			long rowsInserted = getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, values);
	...
	private String formatHighLows(double high, double low) {
		...
		if (temperatureUnit
				.equalsIgnoreCase(getString(R.string.pref_temperature_imperial))) {
			high = ((high * 9) / 5) + 32;
			low = ((low * 9) / 5) + 32;
		} else if (!temperatureUnit
				.equalsIgnoreCase(getString(R.string.pref_temperature_default_metric))) {
	...
	private long addLocation(String locationSetting, String cityName, double lat, double lon) {
		...
		if (cursor.moveToFirst()) {
			...
			Uri returnUri = getContentResolver().insert(
	...
	/**
	 * Represents alarm receiver. Wake this receiver up.
	 *
	 */
